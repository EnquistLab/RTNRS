...
#First, we'll grab an example dataset containing two columnsL row number and scientific name.
fulldata <- read.csv("http://bien.nceas.ucsb.edu/bien/wp-content/uploads/2019/07/tnrs_testfile.csv", header=FALSE)

head(fulldata$V2,n = 20) 
